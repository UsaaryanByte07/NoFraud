  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-4 py-8 w-full">
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-violet-200/50 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-[#e0e5ec] rounded-3xl p-8 sm:p-10 shadow-neu">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-slate-500 text-sm mt-2">Join NoFraud and stay protected</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-bold text-slate-600 mb-2 ml-1">First name</label>
                <input
                  type="text"
                  name="firstName"
              ...
              <div>
                <label className="block text-sm font-bold text-slate-600 mb-2 ml-1">Last name</label>
                <input
                  type="text"
                  name="lastName"
                  value={form.lastName}
